...
// connecting the joke api to the speech api
function tellMe(joke) {
    function test () {
        VoiceRSS.speech({
            key: '393c56c70be2476590608fd366efaf52',
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
...
// getting jokes from API using async function
let joke = '';
const urlAPI = 'https://sv443.net/jokeapi/v2/joke/Any?blacklistFlags=nsfw';
